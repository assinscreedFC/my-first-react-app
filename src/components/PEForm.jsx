...
function PEForm() {
  ...
  return (
    <div className={`w-screen bg-transparent flex flex-col items-center ${on ? "hidden" : ""}`}>
      <form onSubmit={handleSubmit} className="flex flex-col justify-center absolute z-10 w-4/5 px-2 bg-slate-900 gap-3 rounded-md py-3 text-slate-200 items-center">
